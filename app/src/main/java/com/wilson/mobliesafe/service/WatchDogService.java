...
import com.wilson.mobliesafe.activity.EnterPwdActivity;
...
public class WatchDogService extends Service {
    ...
    private class WatchDogReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals("com.wilson.mobliesafe.stopprotect")) {
                //获取到停止保护的对象
    ...
    public void onCreate() {
        ...
        //停止保护
        filter.addAction("com.wilson.mobliesafe.stopprotect");
        //注册一个锁屏的广播
        /**
         * 当屏幕锁住的时候。狗就休息
         * 屏幕解锁的时候。让狗活过来
